...
class _NewAppointmentScreenState extends State<NewAppointmentScreen> {
  ...
  final List<String> timeSlots = [
    ...
    '01:00PM', '01:30PM', '02:00PM', '02:30 PM',
    '03:00PM', '03:30 PM', '04:00PM', '04:30 PM',
  ];
      ...
      if (user != null) {
        ...
        if (userDoc.exists) {
          setState(() {
            ...
            if (userDoc['birthDate'] != null && userDoc['birthDate'].isNotEmpty) {
              try {
  ...
  Future<void> _fetchBookedAppointments() async {
    ...
    try {
      ...
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          ...
          .where('date', isLessThanOrEqualTo: DateFormat('yyyy-MM-dd').format(thirtyDaysLater))
          .get();
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              setState(() {
                                selectedDate = date;
                                if (selectedTime != null && isTimeSlotBooked(selectedTime!)) {
                                  selectedTime = null;
                                }
                              });
                            },
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if (success) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('This time slot is already booked. Please select another time.')),
                            );
                            _fetchBookedAppointments();
                          }
                        },
