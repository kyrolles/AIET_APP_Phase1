...
class ClassSessionCard extends StatelessWidget {
  ...
  Color _getAccentColor() {
    ...
    switch (session.classIdentifier.department) {
      case Department.C: return kPrimaryColor;
      case Department.E: return const Color(0xFF4CAF50); // Green for communications
      case Department.I: return const Color(0xFFFF5722); // Deep orange for industrial
      case Department.M: return const Color(0xFF9C27B0); // Purple for mechatronics
      case Department.G: return const Color(0xFF607D8B); // Blue grey for general
    }
  }
  ...
  String _getPeriodTime() {
    switch (session.periodNumber) {
      case 1: return 'P1 (9:00-10:30)';
      case 2: return 'P2 (10:40-12:10)';
      case 3: return 'P3 (12:20-1:50)';
      case 4: return 'P4 (2:00-3:30)';
      case 5: return 'P5 (3:40-5:10)';
